...
function VM(){
	...
	self.locations = [
			{title: "Atino's Pizza", value: 0, location: {lat: 41.867588, lng: -87.641953}, yelp_id: "atinos-pizza-chicago"},
			{title: "Bellonas Pizza", value: 1, location: {lat: 41.960971, lng: -87.714997}, yelp_id: "bellonas-pizza-chicago"},
			{title: "Dimo's Pizza", value: 2, location: {lat: 41.945206, lng: -87.654694}, yelp_id: "dimos-pizza-chicago-2"},
			{title: "Gino's East", value: 3, location: {lat: 41.896002, lng: -87.623033}, yelp_id: "the-original-ginos-east-of-chicago-chicago-2"},
        	{title: "Lou Malnati's Pizzeria", value: 4, location: {lat: 41.871506, lng: -87.627310}, yelp_id: "lou-malnatis-pizzeria-chicago-9"},          
        	{title: "Pequod's Pizza", value: 5, location: {lat: 41.921931, lng: -87.664308}, yelp_id: "pequods-pizzeria-chicago"}
